        ...
        <div>
            <div>
                ...
                <Dialog isOpen={showDialog} onDismiss={close} style={{ width: "400px", height: "541px", position: "relative", bottom: "36px" }}>
                    ...
                    <img src="https://www.uplooder.net/img/image/57/28c366dc9bfa0a1cdaf9cc3589ac540f/svgexport-9.svg" onClick={close} style={{ cursor: "pointer", position: "relative", right: "390px", bottom: "25px", width: "20px", height: "20px" }} />
                    <BorderContainer>
                ...
                <ButtonR onClick={open}>ثبت نام </ButtonR>
            </div>
