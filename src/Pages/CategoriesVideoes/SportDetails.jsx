...
const SportDetails = () => {
    ...
    useEffect(() => {
        Axios.get('https://www.aparat.com/etc/api/videobyprofilecat/username/aparatsport')
            .then(res => {
    ...
    return (
        <div>
            <Border>
                <Container>
                    <IconContainer>
                        <CategoriesIcon src="https://www.uplooder.net/img/image/47/e08b8af80374918c6f5c8e62fedc85b7/svgexport-26.svg" />
                    </IconContainer>
                    <CategoryTitleText>
                        آپارات ورزشی
                    </CategoryTitleText>
