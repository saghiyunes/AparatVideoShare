...
const Movietitlebar = () => {
    ...
    useEffect(() => {
        Axios.get('https://www.aparat.com/etc/api/videobyprofilecat/username/movies')
            .then(res => {
    ...
    return (
        <div>
            <Border>
                <Container>
                    <IconContainer>
                        <CategoriesIcon src="https://www.uplooder.net/img/image/26/7fcecfd030064aacd3dc000c3f5a7803/svgexport-13.svg" />
                    </IconContainer>
                    <CategoryTitleText>
