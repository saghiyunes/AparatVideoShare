...
const GameDetails = () => {
    ...
    useEffect(() => {
        Axios.get('https://www.aparat.com/etc/api/videobyprofilecat/username/game')
            .then(res => {
    ...
    return (
        <div>
            <Border>
                <Container>
                    <IconContainer>
                        <CategoriesIcon src="https://www.uplooder.net/img/image/68/25ad0f4adcac31ab7a2b6ef0a3982610/svgexport-25.svg" />
                    </IconContainer>
                    <CategoryTitleText>
                        آپارات گیم
                    </CategoryTitleText>
